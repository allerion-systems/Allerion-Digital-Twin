...
(function () {
  ...
  const intents = [
    ...
    // Layer toggles
    { patterns: [/\b(show|enable|turn on|display|activate)\b.*\b(mine|shaft)s?\b/i], action: 'showLayer', target: 'mines' },
    { patterns: [/\b(hide|disable|turn off|remove|deactivate)\b.*\b(mine|shaft)s?\b/i], action: 'hideLayer', target: 'mines' },
    { patterns: [/\b(show|enable|turn on|display|activate)\b.*\b(core|drill)s?\b/i], action: 'showLayer', target: 'cores' },
    { patterns: [/\b(hide|disable|turn off|remove|deactivate)\b.*\b(core|drill)s?\b/i], action: 'hideLayer', target: 'cores' },
    { patterns: [/\b(show|enable|turn on|display|activate)\b.*\bveins?\b/i], action: 'showLayer', target: 'veins' },
    { patterns: [/\b(hide|disable|turn off|remove|deactivate)\b.*\bveins?\b/i], action: 'hideLayer', target: 'veins' },
    ...
    { patterns: [/\b(show|enable|turn on|display|activate)\b.*\bbuild/i], action: 'showLayer', target: 'buildings' },
    { patterns: [/\b(hide|disable|turn off|remove|deactivate)\b.*\bbuild/i], action: 'hideLayer', target: 'buildings' },
    { patterns: [/\b(show|enable|turn on|display|activate)\b.*\b(osm)\b/i], action: 'showLayer', target: 'buildings' },
    { patterns: [/\b(hide|disable|turn off|remove|deactivate)\b.*\b(osm)\b/i], action: 'hideLayer', target: 'buildings' },
    ...
    { patterns: [/\b(show|enable|turn on|display|activate)\b.*(propert|boundar|parcels?)/i], action: 'showLayer', target: 'property' },
    { patterns: [/\b(hide|disable|turn off|remove|deactivate)\b.*(propert|boundar|parcels?)/i], action: 'hideLayer', target: 'property' },
    ...
    { patterns: [/\b(toggle|enable|show|activate)\b.*\b(sun|light|day|sunlight)\b/i], action: 'toggleLighting' },
